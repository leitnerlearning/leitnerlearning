...
Progress stays on the device until you clear site data.
...
Open **http://localhost:8080** (Chrome or Safari recommended for speech).

## Product law

See `AGENTS.md` for hard rules (correctness, languages, autonomy).

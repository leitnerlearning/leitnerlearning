...
- Daily goal remains a **small bite** (cap **5 / 10 / 20**, default 20). After the goal, **Study** under the logo invites more review with no length advertised; session continues as long as they want (due cards only) - never dump a mountain count into the UI.

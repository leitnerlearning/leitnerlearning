...
const READ_STORIES = [
  ...
  },
  {
    ...
    sentences: [
      ...
      { nb: "Ja. Det blir førtifem kroner. Ha en fin dag!", en: "Yes. That will be forty-five kroner. Have a nice day!" },
    ],
    glosses: {
  ...
  },
  {
    ...
    sentences: [
      ...
      { nb: "Fint. Den ligger i nabolaget, tredje etasje.", en: "Fine. It's in the neighbourhood, third floor." },
      { nb: "Er det heis?", en: "Is there a lift?" },
      { nb: "Nei, bare trapper. Husleia inkluderer internett.", en: "No, only stairs. Rent includes internet." },

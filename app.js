...
const SPEECH_HOMOPHONE_GROUPS = {
  ...
  sv: [
    ...
    ["köra", "kora", "koera"],
    ["göra", "gora", "goera"],
    ["förstå", "forstaa", "forsta", "första"],
    ["en gång till", "en gang till", "engang till"],
    ["vad tycker du", "va tycker du"],
    ["jag håller med", "jag haller med"],
    ["jag är överens", "jag ar overens", "jag överens"],
    ["prata långsammare", "prata langsammare", "prata långsammare tack"],
    ["wifi-lösenord", "wifi losenord", "wifilosenord"],
    ["lösenordet", "losenordet", "lösen ord"],
    ["är bussen försenad", "ar bussen forsenad"],
    ["var är utgången", "var ar utgangen", "var är utgång"],
    ["jag är allergisk", "jag ar allergisk"],
    ["el inkluderad", "el ar inkluderad"],
    ["jag förstår inte", "jag forstar inte", "jag forsta inte"],
  ],
  ...
  es: [
    ...
    ["una vez más", "una vez mas", "otra vez"],
    ["qué piensas", "que piensas"],
    ["retrasado", "retraso"],
    ["incluido", "incluida"],
    ["no entiendo", "no entiendo nada"],
    ["dónde está el baño", "donde esta el bano", "dónde está el baño"],
    ["demasiado tarde", "muy tarde"],
    ["demasiado temprano", "muy temprano"],
    ["demasiado caro", "muy caro"],
    ["muchas gracias", "muchas gracias"],
    ["esta noche", "está noche"],
    ["la contraseña", "la contrasena", "contraseña"],
    ["la salida", "donde esta la salida", "dónde está la salida"],
    ["soy alérgico", "soy alergico", "soy alérgica"],
    ["hable más despacio", "mas despacio", "más despacio por favor"],
...
/**
 * Lightweight Spanish ASR code: accents/ñ folded, then metaphone-ish core.
 * Does not collapse sí/si as speech homophones (separate soft-accept table).
 */
function spanishSpeechCode(word) {
  let w = normalizeAnswer(word)
    .replace(/[áàä]/g, "a")
    .replace(/[éèë]/g, "e")
    .replace(/[íìï]/g, "i")
...
function updateDeckCount() {
  ...
  // Live deck size only — tab already says Cards; no restated “cards” in the UI.
  deckCount.textContent = formatted;
  deckCount.setAttribute(
    "aria-label",
    n === 1 ? "1 card in your deck" : `${formatted} cards in your deck`
  );
}
